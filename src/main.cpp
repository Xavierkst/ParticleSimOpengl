...
int main() {
	...
	Shader blinnPhongShader("shaders/blinnPhong/blinnPhong.vert", "shaders/blinnPhong/blinnPhong.frag");
	Shader screenShader("shaders/screen.vert", "shaders/screen.frag");
	Shader shadowMapShader("shaders/shadowMap/shadowMap.vert", "shaders/shadowMap/shadowMap.frag");
	// Shader bpShadowShader("bphongShadow.vert", "bphongShadow.frag");

	unsigned int woodTex = LoadTexture("assets/textures/wood.png");
	...
	Shader compShader("shaders/computeShader/compShader.comp"); // Cr8 shader program and attach shader ID to it
